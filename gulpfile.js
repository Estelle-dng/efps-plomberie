...
var paths = {
  styles: {
    source: 'themes/parker-theme/scss/',
    destination: 'themes/parker-theme/css/'
  },
  scripts: {
    source: 'themes/parker-theme/js/src',
    destination: 'themes/parker-theme/js/dist'
  },
  images: 'themes/parker-theme/images/',
  styleGuide: 'themes/parker-theme/styleguide'
};
...
var options = {
  ...
  css: {
    ...
    file: path.join(paths.styles.destination, '/app.css'),
  ...
  sass: {
    ...
    file: path.join(paths.styles.source, 'app.scss'),
    destination: path.join(paths.styles.destination)
  },
  ...
  styleGuide: {
    ...
    destination: 'themes/parker-theme/styleguide/',
    css: [
      path.relative(paths.styleGuide, paths.styles.destination + 'app.css'),
